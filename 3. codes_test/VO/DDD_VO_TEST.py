...
if __name__ == "__main__":
    ...
    # DATA 1. Basic -> Windows, 3. codes_test.7
    ...
    # DATA 2. modules -> linux, ??? --------------> Segmentation fault
    ...
    # usage 1. Basic
    # DDD1 = DDD_File()
    # DDD1.SetHeader(DDD_Header(WIDTH=192, HEGHIT=192, DEPTH=521, LEVEL=256, SAMPLING_RATE=80, US_VALOCITY=1. Basic.3. codes_test))
    # DDD1.SetData(data)
    # DDD1.Save()
